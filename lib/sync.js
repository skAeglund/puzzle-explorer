...
(function (root) {
  ...
  //     side doesn't.
  //   - Tombstones (entries with deleted:true, used by repertoires; never
  //     set on positions) are absolute — winner takes the entry as-is, no
  //     spread. Otherwise (a) a winning tombstone would drag stale
  //     name/items fields from the loser, and (b) a winning LIVE entry
  //     would inherit deleted:true from a losing tombstone via the
  //     remote→winner spread, which would silently re-tombstone the
  //     resurrection.
