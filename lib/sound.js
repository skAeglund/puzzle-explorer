 ...
 *
 * Drilling-only sound surface: move / capture / check / castle / wrong-move /
 * completion. Search mode is intentionally silent (would feel chatty during
 * position setup).
 *
 ...
 *   error         Error.mp3         (lila standard, AGPLv3+)
 *   confirmation  Confirmation.mp3  (lila standard, AGPLv3+)
